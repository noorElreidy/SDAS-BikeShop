...
public class editOrderFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					editOrderFrame frame = new editOrderFrame();
	...
	public editOrderFrame() {
		...
		JLabel lblNewLabel = new JLabel("enter the order id of the oder you wish to edit :");
		...
		JButton btnNewButton_1 = new JButton("return to customer menu");
